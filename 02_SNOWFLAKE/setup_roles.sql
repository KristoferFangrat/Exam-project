...
GRANT SELECT ON VIEWS ON SCHEMA EXAM_DB.Mart1 TO ROLE ExamDBTRole:
GRANT SELECT ON VIEWS ON SCHEMA EXAM_DB.Mart2 TO ROLE ExamDBTRole:
GRANT SELECT ON FUTURE VIEWS ON SCHEMA EXAM_DB.Mart1 TO ROLE ExamDBTRole:
GRANT SELECT ON FUTURE VIEWS ON SCHEMA EXAM_DB.Mart2 TO ROLE ExamDBTRole:


GRANT SELECT ON VIEWS ON SCHEMA EXAM_DB.Mart1 TO ROLE ExamAnalystRole:
GRANT SELECT ON VIEWS ON SCHEMA EXAM_DB.Mart2 TO ROLE ExamAnalystRole:
GRANT SELECT ON FUTURE VIEWS ON SCHEMA EXAM_DB.Mart1 TO ROLE ExamAnalystRole:
GRANT SELECT ON FUTURE VIEWS ON SCHEMA EXAM_DB.Mart2 TO ROLE ExamAnalystRole:
